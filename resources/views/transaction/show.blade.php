<x-app-layout>
    ...
    {{-- <div class="flex flex-wrap -mx-3 mt-20">
        <div class="w-full max-w-full px-3 mt-6 md:w-7/12 md:flex-none">
            <div
                class="relative flex flex-col min-w-0 break-words  border-0 shadow-soft-xl rounded-2xl bg-clip-border bg-slate-200" >
                <div class="p-6 px-4 pb-0 mb-0  border-b-0 rounded-t-2xl bg-slate-200" >
                    <h6 class="mb-0">Billing Information</h6>
                </div>
                <div class="flex-auto p-4 pt-6 ">
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg divide-y-4 divide-slate-400/25 ">
