<div style="height:1000px"
    class="w-64 position-fixed mb-0 sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
    <div class="px-8">
        ...
        <ul class="mt-12">
            ...
            <x-nav-link :active="request()->routeIs('equipment.index')">
                <a href="{{ route('equipment.index') }}"
                    ...
                    <span class="text-sm ml-2">Equipment</span>
                </a>
            </x-nav-link>



            <li x-data="{ open: false }" x-transition:enter="transition ease-out duration-200"
                ...
                <a href="javascript:void(0)" @click="open = ! open"
                    ...
                    <span class="ml-2 text-sm"> Provinces </span>
                ...
                <ul x-show="open" x-collapse class="bg-slate-900 border border-slate-900  rounded-lg">
                    @foreach ($provinces as $province)
                        <x-nav-link 
                            class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center my-5 ml-4">
                            <a href="{{ route('municipality', [$province->id]) }}" 
                                class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">{{ $province->province_name }}</span>
                            </a>
                        </x-nav-link>
                    @endforeach
                ...
                {{-- <span
                    class="flex w-full text-sm justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center ">
                    {{ province . province_name }}</span> --}}


            </li>
            <li
                class=" mt-3 flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
