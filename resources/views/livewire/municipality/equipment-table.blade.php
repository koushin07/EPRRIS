        ...
        <div class="flex justify-between items-center py-4 bg-white dark:bg-gray-800">
            ...
            <div class="relative ml-3">
                ...
                <input type="text" id="table-search-equipments"
                    ...
                    wire:model="search" placeholder="Search for users">
            </div>
            <div class="mr-3">
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                            <li>
                                <a href="#"
                                    ...
                                    wire:click="all">all</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                    wire:click="serviceable">Servicable</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                    wire:click="poor">Poor</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                    wire:click="unusable">Unusable</a>
                            </li>
